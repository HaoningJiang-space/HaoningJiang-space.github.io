...
<section class="home-hero">
  ...
  <h1>Designing intelligent systems,<br>from circuits to clinics.</h1>
  ...
  <p class="home-hero__focus">My research connects <strong>VLSI CAD</strong>, <strong>reinforcement learning for analog design automation</strong>, and <strong>multimodal medical AI</strong>.</p>
...
<section class="home-section">
  <div class="home-section__heading">
    ...
    <h2>Building intelligent systems across chips and clinics</h2>
  </div>
  <div class="research-grid">
    <article class="research-card"><span class="research-card__number">01</span><h3>AI for VLSI CAD</h3><p>Machine-learning methods for analog layout migration, circuit sizing, and design automation.</p></article>
    <article class="research-card"><span class="research-card__number">02</span><h3>Learning to design</h3><p>Reinforcement learning that turns design intent into efficient, reliable optimization decisions.</p></article>
    <article class="research-card"><span class="research-card__number">03</span><h3>Medical foundation models</h3><p>Multimodal models for medical-image understanding and clinically meaningful diagnosis.</p></article>
  </div>
</section>

<section class="home-section">
  <div class="home-section__heading home-section__heading--split">
    <div><p class="section-kicker">Selected work</p><h2>Research across design automation and health AI</h2></div>
